...
export default function Unit() {
  ...
  const { lessonID, setLessonID } = useUnitContext();
      ...
      {!isLoading && (
        <div className={styles.bottomContainer}>
          <div className={styles.video_Container}>
            ...
            <ProgressBar progress={selectedLesson?.videoProgress ?? 0} />
            <div className={styles.completionTime}>
              ...
              {selectedLesson?.videoLength} Minutes
            </div>
            ...
            <div className={styles.button_Container}>
              <RoutingButton
                ...
                url={`/education/units/1/${selectedLesson?.id}`}
              />
              <RoutingButton
                style={"gray"}
                text={"Restart"}
