import SecurityIndicator from "src/app/account/signup/components/securityIndicator/SecurityIndicator";
import styles from "../inputmodal/inputmodal.module.css";

interface Props {
  onClick: () => void;
}

export default function PasswordInputModal({ onClick }: Props) {
  return (
    <div className={styles.container}>
      <div className={styles.wrapper}>
        ...
        <div className={styles.securityIndicatorWrapper}>
          Requirements
          <SecurityIndicator />
        </div>
