create type activitytype as enum ('frq', 'mcq', 'game');
...
(
    ...
    unity_id    int references units (unit_id) on delete cascade not null,
    description varchar(500)
);
...
(
    unit_progress_id int generated by default as identity,
...
(
    lesson_progress_id int generated by default as identity,
...
(
    video_progress_id int generated by default as identity,
    lesson_id         int references lessons (lesson_id) on delete cascade not null,
    user_id           uuid references auth.users (id) on delete cascade    not null,
...
(
    activity_progress_id int generated by default as identity,
